...
public class MongodbUtils {
    ...
    public static void updateFirst(String accordingKey, Object accordingValue, String[] updateKeys, Object[] updateValues,
        ...
        //修改符合要求的第一条数据
        updateDocumentData(accordingKey, accordingValue, updateKeys, updateValues, collectionName, false);
    }
    ...
    public static void updateMulti(String accordingKey, Object accordingValue, String[] updateKeys, Object[] updateValues,
                                   String collectionName) {
        //修改符合要求的所有数据
        updateDocumentData(accordingKey, accordingValue, updateKeys, updateValues, collectionName, true);
    }
    ...
    public static List<? extends Object> find(Object obj, String[] findKeys, Object[] findValues) {
        //拼接查询条件
        Query query = splicingQueryCriteria(findKeys, findValues);
     ...
     * @return
     */
    public static List<? extends Object> find(Object obj, String[] findKeys, Object[] findValues, String collectionName ,String sortColumn) {
        //拼接查询条件
        Query query = splicingQueryCriteria(findKeys, findValues);
        query.with(Sort.by(Sort.Direction.DESC, sortColumn));
        List<? extends Object> resultList = mongodbUtils.mongoTemplate.find(query, obj.getClass(), collectionName);
        return resultList;
    }
     ...
     * @return
     */
    private static Query splicingQueryCriteria (String[] findKeys, Object[] findValues) {
     ...
     * @param updateValues 修改内容 value数组
     * @param collectionName 集合名
     * @param flag 是否修改所有符合要求的数据（true:修改所有，false:修改第一条）
     */
    private static void updateDocumentData(String accordingKey, Object accordingValue, String[] updateKeys, Object[] updateValues,
                                           String collectionName, boolean flag) {
